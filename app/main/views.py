...
def search(movie_name):
    ...
    '''
    View funtion to display the search results
    '''
...
def single_review(id):
    ...
    '''
    View function to display a single review to be written by a user
    '''
...
def new_review(id):
    ...
    '''
    View function to display form for writting a movie review
    '''
    form = ReviewForm()
    movie = get_movie(id)
